...
canvas.pack()
canvas.bind("<Button-1>",fire) # 마우스 버튼 클릭 이벤트에 함수를 연결한다. canvas.bind("<KeyPress-Up>",keyPress_UP) # 키보드 위쪽방향키 눌림 이벤트에 함수를 연결한다. canvas.bind("<KeyPress-Down>",keyPress_Down) # 키보드 아래쪽방향키 눌림 이벤트에 함수를 연결한다. canvas.bind("<KeyRelease>",keyRelease) # 키보드를 풀어줬을 때 이벤트 처
